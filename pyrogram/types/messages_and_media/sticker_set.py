...
class StickerSet(Object):
    ...
    def __init__(
        ...
        *,
        ...
        stickers: Optional[List["types.Sticker"]] = None,
        thumbs: Optional[List["types.Thumbnail"]] = None,
        is_owned: Optional[bool] = None,
        is_installed: Optional[bool] = None,
        is_archived: Optional[bool] = None,
        is_official: Optional[bool] = None,
        is_allowed_as_chat_emoji_status: Optional[bool] = None,
        needs_repainting: Optional[bool] = None,
        raw: Optional[Union["raw.types.StickerSet", "raw.types.messages.StickerSet"]] = None
    ):
        super().__init__()
        ...
        if documents is not None:
            ...
            if thumb is None and _set.thumb_document_id:
                r = await client.invoke(
                    raw.functions.messages.GetCustomEmojiDocuments(document_id=[_set.thumb_document_id])
                )
