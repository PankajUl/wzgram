...
class GetChatHistory:
    async def get_chat_history(
        ...
        Parameters:
            ...
            min_id (``int``, *optional*):
                Identifier of the oldest message to be returned, inclusive.

            max_id (``int``, *optional*):
                Identifier of the newest message to be returned, inclusive.

            reverse (``bool``, *optional*):
                Pass True to return the messages in chronological order, oldest first.
